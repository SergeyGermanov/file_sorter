...
for file in os.listdir():
    ...
    date = time.strftime('%b %Y', time.gmtime(os.path.getmtime(file)))
    collection_dir = date
    ...
    if not os.path.exists(collection_dir):
        ...
        print("New Folder has been created: " + collection_dir)
        folder_number += 1
...
print("Total number of files copied: " + str(file_number))